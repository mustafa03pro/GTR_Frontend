...
import { Scale, Percent, Package } from 'lucide-react';
import UnitTab from './UnitTab';
import TaxTab from './TaxTab';
import ManageRawMaterialTab from './ManageRawMaterialTab';

const subTabs = [
    { name: 'Unit', icon: Scale, component: UnitTab },
    { name: 'Tax', icon: Percent, component: TaxTab },
    { name: 'Manage Raw Material', icon: Package, component: ManageRawMaterialTab },
];

const ProRawMaterial = ({ locationId }) => {
